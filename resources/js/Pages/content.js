const Content = `
        ...
        <br/>
        <h1>Overview</a></h1>
        <p>The purpose of the dental school interview</p>
        <p>History and rationale of the CDA interview</p>
        <p>Types of Questions</p>
        <p>The Seven Competencies</p>
        <p>Structure of the CDA interview</p>
        <p>How to prepare for your CDA Interview</p>
        <p>Sample CDA interview questions</p>
        <p>BeMo CDA-structured interview prep program</p>
        <p>Contact Us</p>
        <br/>
        ...
        <br/>
        <h1>History, rationale, and the structure of the CDA interview</h1>
        <p>
        ...
        <br/>
        <h1>Structure of the CDA interview</h1>
        <p>
